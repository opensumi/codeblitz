...
(function () {
	...
	/**
	* @param {Uint8Array | { type: 'Buffer', data: number[] }} initialContent 
	* @return {Promise<HTMLImageElement>}
	*/
	async function loadImageFromData(initialContent) {
		const buf = initialContent instanceof Uint8Array ? initialContent : new Uint8Array(initialContent.data);
	...
	window.addEventListener('message', e => {
		switch (e.data.type) {
			case 'init':
				loadImageFromData(e.data.value)
				setActive(true)
				break;
